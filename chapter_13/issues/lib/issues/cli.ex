defmodule Issues.CLI do
  ...
  @moduledoc """
  Handle the comand line parsing and the dispatch to the various functions that
  ...
  def sort_into_ascending_order(issues_list) do
    Enum.sort issues_list, fn issue_one, issue_two ->
      issue_one["created_at"] <= issue_two["created_at"]
    end
  end
